...
def training_steps(
    ...
    G = torch.load(os.path.join(network_pkl, 'model_{}_800_PTI.pkl'.format(file_id))).to(device)
    G.eval()
    ...
    for step in range(num_steps):
        ...
        if finetune_id in [0, 1, 3, 5]:
            ...
            loss_normal, _ = regionl1n(real_imgs_dict['image'], image_normal_o, image_normal_f_o, image_normal_f,
                                       finetune_id)
        elif finetune_id == 2:
            loss_normal, _ = regionl1n(real_imgs_dict['image'], image_normal_o, image_normal_f_o, image_normal_f,
                                       finetune_id)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--cnf_path', help='cnf_path', type=str, default = '')
    ...
    training_steps(args.network_pkl, args.truncation_psi, args.latent_dir, args.outdir, args.num_steps, args.fov_deg,
                   ...
                   args.finetune_id, args.scale, args.file_id,  cnf_path=args.cnf_path, flow_modules=args.flow_modules) # pylint: disable=no-value-for-parameter
